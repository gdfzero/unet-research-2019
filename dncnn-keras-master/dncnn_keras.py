...
#ldct = sorted(glob('/data/CT_data/sparseview/sparseview_90/train/*.flt'))
#ldct = sorted(glob('/data/CT_data/sparseview/sparseview_180/train/*.flt'))
#ldct = sorted(glob('/data/CT_data/images/ldct_1e5/train/*.flt'))
...
#ldct_test = sorted(glob('/data/CT_data/sparseview/sparseview_90/test/*.flt'))
#ldct_test = sorted(glob('/data/CT_data/sparseview/sparseview_180/test/*.flt'))
#ldct_test = sorted(glob('/data/CT_data/images/ldct_1e5/test/*.flt'))
...
model.fit(k1, k2, validation_split=.1, batch_size=12, epochs=50, callbacks=[history])
